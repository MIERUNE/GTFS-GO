...
class GTFSViewer:
    ...
    def __init__(self, iface):
        ...
        self.toolbar = self.iface.addToolBar(u'GTFSViewer')
        self.toolbar.setObjectName(u'GTFSViewer')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GTFSViewer', message)
